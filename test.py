...
with contextlib.closing(psycopg2.connect(**dsn)) as conn, conn.cursor() as cur:
    ...
    query = 'INSERT INTO content.person (id, full_name, created_at, updated_at) VALUES (%s, %s, %s, %s)'
    ...
    query = 'INSERT INTO content.person_film_work (id, film_work_id, person_id, role, created_at) VALUES (%s, %s, %s, %s, %s)'
